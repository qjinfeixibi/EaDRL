...
class EnvState:
    ...
    def update(self, batch_idxes, feat_opes_batch, feat_mas_batch, feat_vehs_batch, proc_times_batch, trans_times_batch, 
               ope_ma_adj_batch, ma_veh_adj_batch,
...
class TFJSPEnv(gym.Env):
    ...
    def __init__(self, case, env_paras, data_source='case'):
        '''
        Input:
            case: an instance generator
            env_paras: a dictionary of parameters for the environment
            max_nums_ope: maximumber number of length of num_opes among all instances
        '''
    ...
    def step(self, action, step_reward=None):
        ...
        self.feat_vehs_batch[self.batch_idxes, 0, :] = torch.count_nonzero(self.ma_veh_adj_batch[self.batch_idxes, :, :], dim=1).float()                                                 
        ...
        self.state.update(
                        ...
                        self.ope_ma_adj_batch, self.ma_veh_adj_batch,
