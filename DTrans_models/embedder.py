...
class DTrans_embedder(nn.Module):
    ...
    def embedding(self, state,  encoder_version=0):
        ...
        onload_trans_time_out = deepcopy(state.trans_times_batch[batch_idxes])                      
    ...
    def get_normalized(self, 
        ...
        offload_trans_time_norm = self.feature_normalize(offload_trans_time)                                                
        offload_trans_time_OV_norm = self.feature_normalize(offload_trans_time_OV)                                                
